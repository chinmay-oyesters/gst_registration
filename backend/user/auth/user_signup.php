...
if($query->rowCount() === 0){
    ...
    $sql = "INSERT INTO 
    user_table (user_password, entity_fullname, entity_pan, entity_phonenumber, entity_email,  user_fullname, user_email, user_phonenumber, register_for, created_at, updated_at) VALUES 
    (:user_password, :entity_fullname, :entity_pan, :entity_phonenumber, :entity_email,  :user_fullname, :user_email, :user_phonenumber, :register_for, :created_at, :updated_at)";
    $query = $con -> prepare($sql);
    ...
    $query->bindParam(':register_for', $register_for, PDO::PARAM_STR);
